...
function release__concatenate_sources_in_release_file() {
  ...
  _release__append_program_run_in_release_file
...
function _release__append_program_run_in_release_file() {
  _release__append_to_release_file '[[ "$0" == "${BASH_SOURCE[0]}" ]] && program__run "$@" || true'
}
